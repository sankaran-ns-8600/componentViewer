...
(function ($, window, document) {
  ...
  var Icons = {
    close: '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6L6.00081 17.9992M17.9992 18L6 6.00085"/></svg>',
    ...
    editImage: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3.78181 16.3092L3 21L7.69086 20.2182C8.50544 20.0825 9.25725 19.6956 9.84119 19.1116L20.4198 8.53288C21.1934 7.75922 21.1934 6.5049 20.4197 5.73126L18.2687 3.58024C17.495 2.80658 16.2406 2.80659 15.4669 3.58027L4.88841 14.159C4.30447 14.7429 3.91757 15.4947 3.78181 16.3092Z"/><path d="M14 6L18 10"/></svg>',
    extractText: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><g transform="translate(12, 12) scale(-1, -1) translate(-12, -12)"><g transform="translate(12, 12) scale(1, -1) rotate(90) translate(-12, -12)"><path d="M2.5,8.18677 C2.60406,6.08705 2.91537,4.77792 3.84664,3.84664 C4.77792,2.91537 6.08705,2.60406 8.18677,2.5 M21.5,8.18677 C21.3959,6.08705 21.0846,4.77792 20.1534,3.84664 C19.2221,2.91537 17.9129,2.60406 15.8132,2.5 M15.8132,21.5 C17.9129,21.3959 19.2221,21.0846 20.1534,20.1534 C21.0846,19.2221 21.3959,17.9129 21.5,15.8132 M8.18676,21.5 C6.08705,21.3959 4.77792,21.0846 3.84664,20.1534 C2.91537,19.2221 2.60406,17.9129 2.5,15.8132"/><line x1="16" y1="7" x2="16" y2="17"/><line x1="12" y1="7" x2="12" y2="13"/><line x1="12" y1="17" x2="12" y2="17.01"/><line x1="8" y1="7" x2="8" y2="17"/></g></g></svg>',
    ...
    fullscreen: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8.00001 3.09779C8.00001 3.09779 4.03375 2.74194 3.38784 3.38785C2.74192 4.03375 3.09784 8 3.09784 8"/><path d="M8.00001 20.9022C8.00001 20.9022 4.03375 21.2581 3.38784 20.6122C2.74192 19.9662 3.09784 16 3.09784 16"/><path d="M16 3.09779C16 3.09779 19.9663 2.74194 20.6122 3.38785C21.2581 4.03375 20.9022 8 20.9022 8"/><path d="M16 20.9022C16 20.9022 19.9663 21.2581 20.6122 20.6122C21.2581 19.9662 20.9022 16 20.9022 16"/><path d="M14.0107 9.99847L20.0625 3.94678"/><path d="M9.99696 14.0024L3.63966 20.3807"/><path d="M9.99732 10.0024L3.84571 3.85889"/><path d="M13.9795 14.0024L20.5279 20.4983"/></svg>',
    fullscreenExit: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.2297 17.9947C14.2192 17.2447 13.704 14.7612 14.2305 14.2347C14.7571 13.7083 17.2398 14.2247 17.9895 14.2355M20.9995 20.9981L14.6147 14.6146"/><path d="M9.76961 17.9944C9.78011 17.2445 10.2953 14.761 9.76881 14.2344C9.24228 13.708 6.75956 14.2245 6.00985 14.2352M2.99981 20.9978L9.38459 14.6144"/><path d="M6.00746 9.76133C6.7572 9.7709 9.24073 10.2832 9.76644 9.75585C10.2921 9.22853 9.77265 6.74581 9.76097 5.99592M9.37696 9.36743L3.00176 3.00244"/><path d="M17.9916 9.76133C17.2419 9.7709 14.7584 10.2832 14.2326 9.75585C13.707 9.22853 14.2264 6.74581 14.2381 5.99592M14.6221 9.36743L20.9973 3.00244"/></svg>',
  ...
  var Overlay = {
    ...
    _minimized: false, _minimizedSnapshot: null,
      ...
      var toolbarIconStyle = '<style id="cv-toolbar-icon-style">' +
        ...
        '.cv-overlay .cv-close,.cv-overlay .cv-fullscreen-toggle,.cv-overlay .cv-theme-toggle,.cv-overlay .cv-carousel-toggle,.cv-overlay .cv-comment-toggle{color:rgba(255,255,255,.95)!important;background:rgba(255,255,255,.08)!important;border:none!important;cursor:pointer!important;align-items:center!important;justify-content:center!important;padding:6px 8px!important;min-width:32px!important;min-height:32px!important;border-radius:6px!important;margin-left:4px!important}' +
        '.cv-overlay .cv-close:hover,.cv-overlay .cv-fullscreen-toggle:hover,.cv-overlay .cv-theme-toggle:hover,.cv-overlay .cv-carousel-toggle:hover,.cv-overlay .cv-comment-toggle:hover{background:rgba(255,255,255,.2)!important}' +
        '.cv-overlay.cv-theme-light .cv-close,.cv-overlay.cv-theme-light .cv-fullscreen-toggle,.cv-overlay.cv-theme-light .cv-theme-toggle,.cv-overlay.cv-theme-light .cv-carousel-toggle,.cv-overlay.cv-theme-light .cv-comment-toggle{color:#333!important;background:rgba(0,0,0,.06)!important}' +
        '.cv-overlay.cv-theme-light .cv-close:hover,.cv-overlay.cv-theme-light .cv-fullscreen-toggle:hover,.cv-overlay.cv-theme-light .cv-theme-toggle:hover,.cv-overlay.cv-theme-light .cv-carousel-toggle:hover,.cv-overlay.cv-theme-light .cv-comment-toggle:hover{background:rgba(0,0,0,.12)!important}' +
        ...
        '.cv-overlay .cv-nav:disabled,.cv-overlay .cv-nav.cv-disabled{opacity:.3!important;cursor:not-allowed!important;pointer-events:none!important}' +
        '.cv-overlay .cv-toolbar .cv-tb-btn:disabled,.cv-overlay .cv-toolbar .cv-tb-btn.cv-disabled{opacity:.35!important;cursor:not-allowed!important;pointer-events:none!important}' +
        '</style>';
      var html =
